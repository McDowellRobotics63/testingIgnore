 ...
 *
 */
public class AutoDriveFixedDistanceStrafe extends Command {
    ...
    public AutoDriveFixedDistanceStrafe(RobotDriveDirection direction, double distance_inches) {
    	...
    	sync_pid = new SynchronousPID(RobotMap.kP_position_strafe, RobotMap.kI_position_strafe, RobotMap.kD_position_strafe);
    	sync_pid.setInputRange(-RobotMap.max_distance_position, RobotMap.max_distance_position);
    	sync_pid.setOutputRange(-RobotMap.max_speed_position_strafe, RobotMap.max_speed_position_strafe);
    ...
    protected void execute() {   
    	...
    	if(Math.abs(desired_distance - distance_traveled) > RobotMap.kTolerance_position)
    	{
	    	...
	    	if(Math.abs(pid_speed) < RobotMap.creep_speed_position_strafe)
	    	{
	    		pid_speed = Math.signum(pid_speed) * RobotMap.creep_speed_position_strafe;
	    	}
	    	else
	    	{
	    	...
	    	if(Math.abs(pid_speed) > RobotMap.max_speed_position_strafe)
	    	{
	    		pid_speed = Math.signum(pid_speed) * RobotMap.max_speed_position_strafe;
	    	}
