 ...
 *
 */
public class AutoVisionAdjustLeftRight extends Command {
    ...
    public AutoVisionAdjustLeftRight() {
    ...
    protected void initialize() {
    	...
    	{
			try {
				pw = new PrintWriter(new File("/home/lvuser/vision_left_right_" + System.currentTimeMillis() + ".csv"));
    	...
    	desired_distance = -Robot.vision.target_shift;
    ...
    protected void execute() {
    	...
    	if(Math.abs(desired_distance - distance_traveled) > RobotMap.kTolerance_position)
    	{
	    	...
	    	System.out.println("<AutoVisionAdjustLeftRight> Remaining Distance: " + (distance_traveled - desired_distance) + ", Speed: " + pid_speed);
	    	
	    	Robot.drive.moveStraightForwardBack(pid_speed);
    	}
    	else
    	{
    		pid_speed = 0;
    		Robot.drive.setVelocityZero();
    		System.out.println("<AutoVisionAdjustLeftRight> Within tolerance, waiting for on target time..");
    	}
    ...
    protected void end() {
    	...
    	System.out.println("AutoVisionAdjustLeftRight end!!");
    }
